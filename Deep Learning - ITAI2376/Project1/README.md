...
**Input:**
![Scenario 1 input](results/screenshots/scenario1_code.png)

**Output:**
![Scenario 1 output](results/screenshots/scenario1_answer.png)

### Example 2 — Multi-crossing risk scan

**Input:**
![Scenario 2 input](results/screenshots/scenario2_code.png)

**Output:**
![Scenario 2 output](results/screenshots/scenario2_answer.png)

### Example 3 — City planner infrastructure analysis

**Input:**
![Scenario 3 input](results/screenshots/scenario3_code.png)

**Output:**
![Scenario 3 output](results/screenshots/scenario3_answer.png)
